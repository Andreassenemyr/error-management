...
import { eventFromMessage } from "../client";
...
import { DynamicSamplingContext, Event, EventHint, SeverityLevel } from "../types";
import { eventFromUnknownInput } from "../utils/eventbuilder";
import { logger } from "../utils/logger";
import { ParameterizedString } from "../utils/parameterize";
import { getDynamicSamplingContextFromClient, getDynamicSamplingContextFromSpan } from "./tracing/dynamicSamplingContext";
...
export class ServerRuntimeClient<O extends ClientOptions & ServerRuntimeClientOptions = ServerRuntimeClientOptions> extends BaseClient<O> {
    ...
    public captureCheckIn(checkIn: CheckIn, monitorConfig?: MonitorConfig, scope?: Scope): string {
        ...
        const { environment, tunnel } = options;
