import { HrTime, SpanStatus } from "@opentelemetry/api";
...
export type SpanAttributes = Partial<{
    'ribban.origin': string;
    'ribban.op': string;
    'ribban.source': TransactionSource;
    'ribban.sample_rate': number;
}> &
...
export interface RibbanSpanArguments {
    /**
