...
require('../../../node_modules/chalk/source/index.js');
...
function wrappingLoader(
    ...
    if (wrappingTargetKind === 'page' || wrappingTargetKind === 'api-route') {
        ...
        if (misc.stringMatchesSomePattern(parameterizedPagesRoute, excludeServerRoutes, true)) {
            this.callback(null, userCode, userModuleSourceMap);
            return;
        }
        ...
        if (nextjsRequestAsyncStorageModulePath !== undefined) {
            ...
            if (!showedMissingAsyncStorageModuleWarning) {
                ...
                console.warn(
                    `${undefined('warn')}  - The Sentry SDK could not access the ${undefined.cyan(
                        'RequestAsyncStorage',
