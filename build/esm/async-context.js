...
import { getDefaultCurrentScope, getDefaultIsolationScope } from './current-scopes.js';
...
function getAsyncContextStack() {
    ...
    const ribban = getRibbanCarrier(registry) ;
...
export { AsyncContextStack, getAsyncContextStrategy, getStackAsyncContextStrategy };
